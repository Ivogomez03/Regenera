...
import axios from "axios"; // Asegúrate de tener configurado tu cliente axios o usa el default
...
import { Save, BarChart2, FileText, ArrowLeft } from "lucide-react";
...
const METODOS_CALCULO = ["MANUAL", "SENSOR", "PLANILLA", "OTRO"];
        ...
        <main className={styles.main}>
            ...
            <div className={styles.container}>
                <div className={styles.headerSection}>
                    <h1><BarChart2 className={styles.iconTitle} /> Indicadores y Metas Ambientales</h1>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className={styles.formGrid}>
                        ...
                        <div className={styles.column}>
                            ...
                            <div className={styles.row}>
                                ...
                                <div className={styles.formGroup}>
                                    <label>Método*</label>
                                    <select {...register("metodoCalculo")}>
                                        {METODOS_CALCULO.map(m => <option key={m} value={m}>{m}</option>)}
                                    </select>
                                </div>
                            </div>
