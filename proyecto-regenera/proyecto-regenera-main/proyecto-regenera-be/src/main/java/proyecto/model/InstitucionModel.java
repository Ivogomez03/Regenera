...
@Entity
@Table(name = "institucion", schema = "ga", indexes = {
...
public class InstitucionModel {
        ...
        @JoinColumn(name = "id_localidad", nullable = false, foreignKey = @ForeignKey(name = "fk_institucion_localidad"))
        private LocalidadModel localidad;

        @ManyToOne(fetch = FetchType.LAZY, optional = false)
        @JoinColumn(name = "id_rubro_industrial", nullable = false, foreignKey = @ForeignKey(name = "fk_institucion_rubro"))
        private RubroIndustrialModel rubroIndustrial;

        @NotBlank
        @Column(name = "declaracion_alcance_sga", columnDefinition = "TEXT", nullable = false)
        private String declaracionAlcanceSga;

        @NotBlank
        @Column(name = "declaracion_politica_ambiental", columnDefinition = "TEXT", nullable = false)
        ...
        public boolean equals(Object o) {
                if (this == o)
                        return true;
                if (!(o instanceof InstitucionModel other))
                        return false;
